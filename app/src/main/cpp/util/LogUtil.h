...
#ifndef DIDI_LOGUTIL_H
#define DIDI_LOGUTIL_H

#include<android/log.h>
#include <sys/time.h>

#define  LOG_TAG "native_render"
#define  LOG_TAG_ASSMIP "assimp_check_error"
...
#define  LOGCATD(...)  __android_log_print(ANDROID_LOG_INFO,LOG_TAG,__VA_ARGS__)
#define  LOGCATI(...)  __android_log_print(ANDROID_LOG_INFO,LOG_TAG_ASSMIP,__VA_ARGS__)
...
#define GO_CHECK_GL_ERROR(...)   LOGCATI("CHECK_GL_ERROR %s glGetError = %d, line = %d, ",  __FUNCTION__, glGetError(), __LINE__)

#define DEBUG_LOGCATE(...) LOGCATD("DEBUG_LOGCATE %s line = %d",  __FUNCTION__, __LINE__)

#endif //DIDI_LOGUTIL_H
